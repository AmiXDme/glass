    ...
    renderSlide3() {
        return html`
            <div class="slide slide-3 ${this.currentSlide === 2 ? 'active' : ''}">
                ...
                <div class="slide-content">
                    Help Gemini understand your situation better by sharing your context - like your resume, the job description, or interview
                    details.
                </div>
                <textarea
    ...
    renderSlide5() {
        return html`
            <div class="slide slide-5 ${this.currentSlide === 4 ? 'active' : ''}">
                ...
                <div class="slide-content">
                    Pickle Glass is completely free to use. Just add your Gemini API key from Google AI Studio and start getting AI-powered assistance in your interviews
                    and meetings!
                </div>
            </div>
        `;
